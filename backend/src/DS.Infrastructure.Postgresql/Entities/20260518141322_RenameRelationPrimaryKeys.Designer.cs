...
namespace DS.Infrastructure.Postgresql.Entities
{
    ...
    [Migration("20260518141322_RenameRelationPrimaryKeys")]
    partial class RenameRelationPrimaryKeys
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DS.Domain.Relation.DepartmentLocation", b =>
                {
                    b.HasOne("DS.Domain.Entities.Department", null)
                        .WithMany()
                    ...
                    b.HasOne("DS.Domain.Entities.Location", null)
                        .WithMany()
                        .HasForeignKey("LocationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
            ...
            modelBuilder.Entity("DS.Domain.Relation.DepartmentPosition", b =>
                {
                    ...
                    b.HasOne("DS.Domain.Entities.Position", null)
                        .WithMany()
